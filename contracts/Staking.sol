...
contract Staking is ReentrancyGuard{
  ...
  function withdrawStakedTokens(uint amount) external payable nonReentrant updateReward(msg.sender)  {
    require(amount>0,"Amount must be greater than zero");
  ...
  function getReward() external payable nonReentrant updateReward(msg.sender){
